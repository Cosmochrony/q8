...
\begin{document}
  ...
  \begin{abstract}
    ...
    $\mathbb{R}_{\tau} \times \heisR$ and closing Q5b-O2 conditionally on bridge existence.
  \end{abstract}
  ...
  \section{Casimir Identification and Proof of the Main Theorem}\label{sec:casimir}
    ...
    \subsection{The commutator term maps to the Casimir under the bridge}
      ...
      \begin{proof}
        ...
        Lemma~\ref{lem:casimir-unique}, be a scalar multiple of the Casimir eigenvalue on that direction.
        Since $\Csu$ acts as $2 \cdot \mathrm{Id}$ on all of $\Sym^{2}(\Vr)$ (including the $e_{0}$
        eigenspace), the coefficient is $\Az = 2$.
        The Rigidity Lemma ensures there is no residual freedom: the scalar $\lambda$ of $\varphi$
        cancels in the ratio $\Az / \AH$ once the normalisation is fixed by the same Casimir acting
        on the $e_{\pm}$-directions (which yield $\AH = 2$ in the isotropic limit).
      \end{proof}
...
this gives signature $(-,+,+,+)$ and closes Q5b-O2 conditionally on bridge existence.
      \end{proof}
  ...
  \section{Consequences for the Effective Metric and Q5b-O2}\label{sec:consequences}
    ...
    \subsection{Resolution of Q5b-O2}
      ...
      \begin{corollary}[Full rank-$4$ effective metric]\label{cor:metric}
        ...
        Open problem $Q5b$-$O2$ is resolved conditionally on the existence of the equivariant bridge.
      \end{corollary}
